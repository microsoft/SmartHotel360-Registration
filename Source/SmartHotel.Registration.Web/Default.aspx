<%@ Page Title="Home Page" Async="true" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SmartHotel.Registration._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="ShowKPIsButton" class="btn btn-secondary" runat="server" OnClick="ShowKPIsBtn_Click"  Text="Display KPI" />
    <div class="row">
